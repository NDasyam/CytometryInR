...
For the YouTube livestream recording (starting Wednesday), click [here](https://www.youtube.com/@CytometryInR)
...
:::{.callout-important}
Please make sure to [sync]() your forked version of the CytometryInR repository, and [pull](/course/00_Git/index.qmd#pull) any changes to your local computer's CytometryInR project folder so that you have the most recent version of the code and data available. 
:::
